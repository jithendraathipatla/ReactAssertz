...
const overview = () => {
    return (
        <div>
        <SEOComponent title="Prestige  Waterford Overview | Prestige  Waterford - Hyde | Prestige  Waterford -Regent" des="This page helps you to understand more on the Assertz Marq 2.0 Property. The website you will see will help you to get more informative on Assertz Marq 2.0"/>
        <Navbar/>
        <SideMenu/>
        <div className="box">
