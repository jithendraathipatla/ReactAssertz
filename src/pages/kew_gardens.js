...
const Key = () => {
    ...
    const [exterior, setexterior] = useState([
      ...
      const [floor, setfloor] = useState([
        ...
        {
          name: "1146 SqFt - 2 BHK",
          img: FloorPlanTwo,
        },
        {
          name: "1291 SqFt - 2 BHK + Study",
          img: FloorPlanThree,
        },
        {
          name: "1067 SqFt - 3 BHK",
          img: FloorPlanFour,
        },
    ...
    return (
        <Layout title="prestige kew gardens | reviews | Brouchere | Location" project="Prestige Kew_gardens" page="kew_gardens">
         ...
         <hr/>
         <Pricingcomponent proj="Kew Gardens Pricing" project="Prestige Kew Gardens" tabeltwo={squarefeet} page="kew_gardens"/>
         <hr/>
