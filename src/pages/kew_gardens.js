...
const Key = () => {
    ...
    return (
        <Layout title="prestige kew gardens | reviews | Brouchere | Location" project="Prestige Kew_gardens">
         ...
         <hr/>
         <Pricingcomponent proj="Kew Gardens Pricing" project="Prestige Kew Gardens" tabeltwo={squarefeet}/>
         <hr/>
