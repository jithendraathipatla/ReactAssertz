...
const pricing = () => {
    return (
        ...
        <Description>Prestige  Waterford Pricing details are shown below, The Prestige  Waterford Comprises of 1,2 & 3BHK Apartments. If you want to get in touch with us submit any of the forms and will be in your ear's as soon as possible.
        <br/>
